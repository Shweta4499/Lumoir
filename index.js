...
// Remove the clock safely without errors
const timeElem = document.querySelector('.time');
if (timeElem) {
  timeElem.remove(); // Removes the element if it exists
}
// Helper function to smooth-scroll via Locomotive
